...
--model="training/voc0712/JDetNet/20180512_18-25_ds_PSP_dsFac_32_hdDS8_1/test/test.prototxt" \
--iterations="496" \
--display_sparsity=1 \
...
--gpu "0" 2>&1 | tee training/voc0712/JDetNet/20180512_18-25_ds_PSP_dsFac_32_hdDS8_1/test/run.log
