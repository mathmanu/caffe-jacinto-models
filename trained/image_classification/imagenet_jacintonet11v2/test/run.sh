...
--model="training/imagenet_jacintonet11v2_2017-08-14_19-50-34/test/test.prototxt" \
--iterations="1000" \
--display_sparsity=1 \
--weights="training/imagenet_jacintonet11v2_2017-08-14_19-50-34/sparse/imagenet_jacintonet11v2_iter_160000.caffemodel" \
--gpu "0,1,2" 2>&1 | tee training/imagenet_jacintonet11v2_2017-08-14_19-50-34/test/run.log
