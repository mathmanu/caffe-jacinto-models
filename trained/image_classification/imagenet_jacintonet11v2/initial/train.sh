...
--solver="training/imagenet_jacintonet11v2_2017-06-30_02-08-23/initial/solver.prototxt" \
...
--gpu "0,1,2" 2>&1 | tee training/imagenet_jacintonet11v2_2017-06-30_02-08-23/initial/train.log
