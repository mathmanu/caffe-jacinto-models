...
'pretrain_model':'$weights','use_image_list':$use_image_list,'shuffle':$shuffle,'num_output':$num_output,\
'image_width':$image_width,'image_height':$image_height, 'num_test_image':$num_test_image,'test_batch_size':$test_batch_size}" 
...
'pretrain_model':'$weights','use_image_list':$use_image_list,'shuffle':$shuffle,'num_output':$num_output,\
'image_width':$image_width,'image_height':$image_height,\
'num_test_image':$num_test_image,'test_batch_size':$test_batch_size,\
