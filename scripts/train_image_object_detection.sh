...
dataset=HAGL_MIXED_DIFF_FIXED    #cityscapes-ssd768x384,cityscapes-ssd512x512, cityscapes-ssd512x256,
...
folder_name=training/"$dataset"/"$model_name_to_print"/"$DATE_TIME"_"ds_PSP_dsFac_32_hdDS8_1_kerMbox_1_smallOBj_0_ignrDiffGt_1";mkdir training/"$dataset";mkdir training/"$dataset"/"$model_name_to_print";mkdir $folder_name
