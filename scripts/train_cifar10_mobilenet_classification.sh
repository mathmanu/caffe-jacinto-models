...
config_name_prev=$config_name
config_name_nonsparse=$config_name
...
#-------------------------------------------------------
#structured sparsification and finetuning
stage="structured_sparse"
weights=$config_name_nonsparse/"$dataset"_"$model_name"_iter_$max_iter.caffemodel
...
'sparsity_target':0.8,'sparsity_start_iter':4000,'sparsity_start_factor':0.0,\
'sparsity_step_iter':1000,'sparsity_step_factor':0.02,\
'sparsity_group_factor':0.75,'sparsity_group_size':8,\
}"
